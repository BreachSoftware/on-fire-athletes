 ...
 */
export function assignCardEmailBody(
					...
					<table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
						<tr>
							<td colspan="2" style="vertical-align: top;">
								<img border="0" src="${baseUrl}/youre-on-fire-logo.png"  alt="You're On Fire" style=" width: 425px; height: 75px; padding-left: 15px; padding-top: 30px; padding-bottom: 15px">
							</td>
						</tr>
						<tr>
							<td style="vertical-align: top; padding-right: 60px;">
								<div style="color: white; background: #12171E; line-height: 140%; text-align: left; word-wrap: break-word;">
									...
									<a href="${baseUrl}/${recepientUUID ? "login" : "signup"}?generatedByUUID=${generatedByUUID}&cardUUID=${cardUUID}&toUUID=${recepientUUID}&fromUUID=${fromUUID}">
									...
									<p style="line-height: 140%; margin-bottom:75px; padding-left: 15px;">The OnFire Athletes Team</p>
								</div>
							</td>
							<td style="vertical-align: top; text-align: right;">
								<img class="cardImage" border="0" src="${cardImage}" alt="An image of your requested OnFire Athletes card" style="display: block; margin-top: -100px; max-width: 300px; height: auto; transform: rotate(348deg); -webkit-transform: rotate(348deg); -ms-transform: rotate(348deg); padding-bottom: 40px; padding-right: 20px;" />
							</td>
						</tr>
					</table>
				</td>
