 ...
 */
export function contactEmailBodyAttachment(firstName: string, lastName: string, email: string, subject: string, message: string, attachment: string): string {
			...
			<td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 10px 20px;font-family: Arial, sans-serif; font-size: 18px;" align="left">
				...
				<tr>
					...
					<div style="color: white; background: #12171E; line-height: 150%; text-align: left; word-wrap: break-word;">
						...
						<p style="padding-left: 15px;  padding-bottom: 20px; color: white;">${message}</p>
						<p style="line-height:120%;"></p>
						<p style="line-height:120%;"></p>
						<img src="${attachment}" alt="Attachment" style="max-width: 100%; height: auto; width: auto;"/>
					</div>
					</td>
