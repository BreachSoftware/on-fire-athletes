				...
				<Box w="100%">
					...
					<VStack	spacing={50}>
						...
						>
							...
							<Card
								variant={"digital"}
								height={useBreakpointValue({ base: "min-content", sm: 400 })}
								width={useBreakpointValue({ base: "90%", sm: "20%" })}
								minW={useBreakpointValue({ base: "auto", sm: 300 })}
								paddingLeft={useBreakpointValue({ base: 0, sm: 3 })}
								paddingRight={useBreakpointValue({ base: 0, sm: 3 })}
							>
							...
							<Card
								variant={"physical"}
								height={useBreakpointValue({ base: "min-content", sm: 400 })}
								width={useBreakpointValue({ base: "90%", sm: "40%" })}
								minW={useBreakpointValue({ base: "auto", sm: 300 })}
								paddingLeft={useBreakpointValue({ base: 0, sm: 3 })}
								paddingRight={useBreakpointValue({ base: 0, sm: 3 })}
							>
								...
								<CardHeader>
									...
									>
										...
										<Box
											...
											fontSize={useBreakpointValue({ base: "10px", sm: "sm" })}
										>
											Recommended
										</Box>
									</Flex>
								...
								>
									...
									>
										...
										>
											<CheckItem text={"Lorem Ipsum"} />
											<CheckItem text={"Dolor Sit"} />
											<CheckItem text={"Sed Do Eiusmod kvjndcln"} />
											<CheckItem text={"Lorem Ipsum"} />
											<CheckItem text={"Dolor Sit"} />
										</VStack>
									</HStack>
