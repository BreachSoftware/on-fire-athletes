...
const data = {
	...
	subheader: "We’re happy to announce our donation to Mater Academy in East Las Vegas. Watch the video below to see our Technical Director Frederick Lenna explain our platform and our donation to Mater Academy East Las Vegas with GMEX Ambassador Kyle Meade.",
...
export default function Article() {
	...
	return (
		<>
			...
			>
				<Sidebar height="100vh" backgroundPresent={false} isGridIconAltColor={true} />
			</Flex>
			...
			>
				...
				<Flex
					...
					h={{ base: "50vh", sm: "65vh", md: "80vh", lg: "80vh", xl: "90vh" }}
					...
					>
						...
						>
							...
							<Link href="/" width={"100%"}>
								<Text
									width={"100%"}
									fontSize={{ base: "xs", md: "2xl", lg: "14px" }}
									textAlign="center"
					...
					>
						...
						>
							<Flex
								...
								width={"fit-content"}
							>
								<ChevronLeftIcon w={6} h={6} color={"gray.1700"} />
								<Text
									width={"100%"}
									fontSize={{ base: "xs", md: "2xl", lg: "14px" }}
									textAlign="center"
