...
export default function EditProfileModal({
	...
	async function processProfileImageSelect(files: FileList) {
		...
		await uploadAssetToS3(filename, resizedPhotoBlob, "profile_media", "image/png");

		setEditableProfilePicture(`https://gamechangers-media-uploads.s3.amazonaws.com/profile_media/${filename}`);
			...
			>
				...
				<ModalFooter>
					<Flex justifyContent={"center"} maxW={"100%"} w={"100%"} >
						<Button maxW={{ base: "100%", sm:"75%", md:"60%", lg:"50%" }} variant="next" onClick={() => {
							checkUpdate();
						}}>Save Changes</Button>
					</Flex>
				</ModalFooter>
