 ...
 * @returns {JSX.Element}
 */
export default function ProfileMediaDeleteModal({ media, mediaType, isOpen, onClose, handleDelete }: Props) {
	return (
		<Modal
			isOpen={isOpen}
			onClose={onClose}
			...
			<ModalContent
				...
				<ModalHeader width="90%">
					Are you sure you want to delete this {mediaType === MediaType.PHOTO ? "photo" : "video"}?
				</ModalHeader>
				...
				<ModalFooter alignItems="center" justifyContent="space-between" display="flex">
					<Button bgColor="#323232" _hover={{ bgColor: "#2B2B2B" }} onClick={() => {
						onClose();
					}}>
						Cancel
					</Button>
