 ...
 * @returns {JSX.Element}
 */
export default function ProfileBioMedia({ media, isEditable, handleDelete }: Props) {
	...
	return (
		<>
			<Box position="relative" w="full" h="full" role="group" cursor="pointer">
				<IconButton
				...
				/>
				<AspectRatio w="full" position="relative" ratio={1} onClick={onOpenView} overflow="hidden">
					{mediaType === MediaType.PHOTO ? (
						...
						<Box w="full" h="full" _groupHover={{ transform: "scale(1.05)" }} transition="transform 0.1s ease-out">
							<video
								src={media}
								style={{ width: "100%", height: "100%", objectFit: "cover" }}
								muted={true}
