...
export default function CardInfoElement(props: CardInfoElementProps) {
    ...
    const isBuyable =
        card.price !== 0 && card.currentlyAvailable > 0 && !props.privateView;
    ...
    function focusCurrentCard() {
        ...
        if (
            props.card instanceof SerializedTradingCard &&
            props.setCurrentSerializedCard
        ) {
    ...
    function actionButtonUI() {
        ...
        if (buttonShouldBeDisabled) {
            ...
            if (
                props.tabName === TabName.Created ||
                props.tabName === TabName.Traded
            ) {
                return (
                    <Button
                        variant="next"
    ...
    return (
        <Stack flexDirection={{ base: "column", xl: "row" }}>
            ...
            >
                <TrendingCard
                    passedInCard={card as unknown as TradingCardInfo}
                    slim
                    overrideCardClick={focusCurrentCard}
                />
            </Link>
            <Flex
                direction="column"
            ...
            >
                ...
                >
                    {card.price !== 0 ? (
                        <>
                            <Text>Price</Text>
                            <Text bgColor="gray.600" py="8px" px="20px">
                    ...
                    {props.card instanceof SerializedTradingCard ? (
                        <>
                            ...
                            <Text bgColor="gray.600" py="8px" px="20px">
                                {props.card.serialNumber} of {card.totalCreated}
                            </Text>
                        </>
                    ) : (
                        <>
                            <Text>Cards Available</Text>
                            <Text bgColor="gray.600" py="8px" px="20px">
