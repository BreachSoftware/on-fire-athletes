...
export default function NavBar(props: NavBarProps) {
	...
	useEffect(() => {
		...
		setIsMobile((/mobile|android|iphone|ipod|blackberry|iemobile|opera mini/i).test(userAgent) && isSmallScreen);
	}, [ isSmallScreen ]);

	return (
		<Box position="relative" zIndex={99} mb={isMobile ? 0 : 0}>
			<Flex
				bgGradient={{ base: "linear(to-b, #000, #000000fe)", md: "linear(to-b, rgba(0,0,0,1), rgba(0,0,0,0.6), rgba(0,0,0,0))" }}
				...
				<Flex flex={1} align={"center"} justify={"space-between"} position={"relative"}>
					{/* Logo */}
					<Link href="/" style={{ outline: "none", boxShadow: "none" }}>
						<Image src={OnFireLogo.src} alt="Logo" width={"59px"} mr="16px" ml="15px" />
					</Link>
