	...
	return (
		<>
			<Flex
				...
				<Flex
					flexDir="column"
					bgGradient={{ base: "linear(to-b, #000000f0 60%, #000000a9 80%, #00000000)", md: "none" }}
				...
				>
					...
					<Text
						...
						fontSize={{ base: "48px", lg: "76px", xl: "100px" }}
						color="white"
						fontWeight={700}
				...
				<Flex flexDir="column" my="80px" gridGap={6} display={{ base: "none", md: "flex" }} px={{ "base": "32px", "lg": "64px", "2xl": "100px" }}>
					<HeroCTAButton
