	...
	return (
		<>
			...
			<Accordion
				...
				index={activeIndex}
				onChange={(index) => {
					setActiveIndex(typeof index === "number" ? index : undefined);
				}}
				{...rest}
			>
										...
										<>
											<h2>
												...
												<AccordionButton
													...
													border= {"solid"}
													borderWidth={5}
													borderColor={isExpanded ? styling.limeGreen : styling.backgroundColor}
													borderBottom={"none"}
													textColor={isExpanded ? styling.limeGreen : styling.buttonColor}
													padding={"15px"}
													paddingLeft={{ base: "20px", md: "45px" }}
													minH={"75px"}
													...
													_hover={isExpanded ? {
														...
														// Button is expanded
														backgroundColor: isMobile ? styling.backgroundColor : styling.limeGreen,
														textColor: isMobile ? styling.limeGreen : styling.buttonColor,
														...
														borderColor: isMobile ? styling.backgroundColor : styling.limeGreen,
												...
												>
													...
													>
														...
														<Flex
															...
															align={"center"}
															justify={"center"}
															backgroundColor={styling.limeGreen}
															width={10}
															height={10}
															transition={"all .3s ease"}
														>
															{isExpanded ? (
																<MinusIcon fontSize="12px" color={styling.buttonExpandedColor} />
															) : (
																<AddIcon
																	fontSize="12px"
																	color={styling.buttonExpandedColor}
																/>
															)}
														</Flex>
													</Flex>
											...
											>
												{typeof item.content === "string" ? item.content : item.content.map((content, index) => {
													return (
