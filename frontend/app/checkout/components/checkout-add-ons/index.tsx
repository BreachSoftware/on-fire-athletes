...
export default function CheckoutAddOns() {
    ...
    const bagTagOption: AddOnOptionType = {
    ...
    const digitalCardOption: AddOnOptionType = {
    ...
    const physicalCardOption: AddOnOptionType = {
    ...
    const addOnOptions: Record<DatabasePackageNames, AddOnOptionType[]> = {
        ...
        [DatabasePackageNames.ROOKIE]: [bagTagOption, physicalCardOption],
        [DatabasePackageNames.ALL_STAR]: [bagTagOption, physicalCardOption],
