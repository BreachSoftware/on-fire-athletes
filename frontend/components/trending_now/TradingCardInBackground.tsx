...
import { hexToRgb, rgbToHsl, hslToRgb, rgbToHex, saturateHex } from "../create/OnFireCard/card_utils";
 ...
 */
export default function TradingCardInBackground({ card, filter, onCardClick, isPageFlipping, passedInCard, onFireCardRef }: TradingCardInBackgroundProps) {
