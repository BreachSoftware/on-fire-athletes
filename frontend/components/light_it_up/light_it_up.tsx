...
export default function LightItUp() {
	...
	const gameSections: LightItUpSection[] = [
		...
		{
			id: 1,
			image: "/For-Athletes-Card-Mockup.png",
			imageOverlaySubtitle: "FOR",
			imageOverlayTitle: "ATHLETES",
			title: "Create a Custom Card",
			description: "Create your custom Digital & Physical AR sports cards to Capture, Showcase, Trade & Sell your favorite sports moments.",
			buttonTitle: "START CREATING",
			buttonLink: "/create",
		},
		{
			id: 2,
			image: "/Locker-Room-Color.png",
			imageOverlaySubtitle: "FOR",
		...
		{
			id: 3,
			image: "/For-Everyone-Memorabelia-Mockup-Color.png",
			imageOverlaySubtitle: "FOR",
			imageOverlayTitle: "EVERYONE",
			title: "Win Prizes & Experiences",
			description: "Create and Collect for chances to win one-of-a-kind prizes such as memorabilia, apparel, gear, game tickets, exclusive experiences.",
	...
	return (
		<Flex
			...
			<Grid minW="100dvh" display={{ base: "none", lg: "grid" }} gridTemplateColumns={{ lg: "1fr 60px 1fr 60px 1fr", xl: "1fr 100px 1fr 100px 1fr" }}>
					...
					return (
						<Fragment key={index}>
							...
							{index < gameSections.length - 1 && (
								<GridItem key={index + 1} display={{ base: "none", md: "inline" }}>
									<LightItUpDivider />
								</GridItem>
							)}
						</Fragment>
