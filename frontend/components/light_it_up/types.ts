/**
 * Temporary types for the LightItUp component so the sections can be passed between components.
 */
export type LightItUpSection = {
    id: number; // 1,
    image?: string; // "/For-Athletes-Card-Mockup.png",
    videoUrl?: string; // "For Athletes Playing Card.mp4",
