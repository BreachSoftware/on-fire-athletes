 ...
 */
function LightItUpCard({ image, imageOverlayTitle, imageOverlaySubtitle, title, description, buttonTitle, buttonLink }: LightItUpCardProps) {
	return (
		<Center>
			<VStack color="white" position="relative">
				{/* Image container */}
				<Flex position="relative" maxW="100%" maxH="100%" justifyContent="center" alignItems="center" overflow="visible">
					<Image
					...
					<VStack pos={"absolute"} bottom={0} spacing={0}>
						...
						<Text fontSize={{ base: "36px", lg: "40px" }} fontFamily="Brotherhood, Regular" lineHeight="56px">
				...
				{/* Card content */}
				<Flex mt={4} zIndex={1} width={"100%"} alignItems={"center"} flexDir={"column"}>
					<Text
						color={"green.100"}
						textAlign={"center"}
					...
					<LightItUpCTAButton link={buttonLink}>{buttonTitle}</LightItUpCTAButton>
