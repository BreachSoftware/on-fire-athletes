...
import { VStack, Box, Image, Flex, Heading, useBreakpointValue } from "@chakra-ui/react";
...
import OrangeA from "@/public/step_one_template_cards/orange_a.png";
import OrangeB from "@/public/step_one_template_cards/orange_b.png";
import PurpleA from "@/public/step_one_template_cards/purple_a.png";
import PurpleB from "@/public/step_one_template_cards/purple_b.png";
...
export default function Step1() {
	...
	// Cycle through shown card styles
	useEffect(() => {
		const intervalId = setInterval(() => {
			setCardIndex((prevIndex) => {
				return (prevIndex + 1) % cardStyles.length;
			});
		}, 3000);
		return() => {
		...
		<>
			...
			>
				...
				<VStack
					...
					textAlign={"center"}
				>
					{!isMobile && <Heading color={"green.100"}>Step 1:</Heading> }
					<Heading color={"white"} fontFamily={"'Brotherhood', sans-serif"}>Select Your Layout</Heading>
				</VStack>
				...
				>
					{/* Cards and Shadows */}
					{cardStyles[cardIndex].map((image, index) => {
						return (
							<Flex
								key={index}
							...
							>
								...
								{/* Drop Shadow */}
								<Box alignSelf="center" paddingTop="30px" w={"120%"}>
