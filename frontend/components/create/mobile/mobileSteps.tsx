...
export const mobileCardCreationSteps: React.ReactElement[] = [
	...
	<MobileColorGrid
		key={"6"}
		colorPickerAttributes={[ "borderColor", "numberColor", "nameColor", "signatureColor" ]}
		colorPickerTitles={[ "Border", "Number", "Name", "Signature" ]}
	/>,
	...
	<MobileColorGrid
		key={"9"}
		colorPickerAttributes={[ "backgroundMainColor", "backgroundAccentColor", "backgroundTextColor" ]}
		colorPickerTitles={[ "Primary", "Secondary", "Last Name" ]}
	/>,
