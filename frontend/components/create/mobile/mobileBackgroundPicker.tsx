...
import { Button, Image, Modal, ModalBody, ModalContent, ModalOverlay, useDisclosure } from "@chakra-ui/react";
...
export default function MobileBackgroundPicker() {
		...
		return (
			<Button
				...
				onClick={() => {
					...
					cardHook.setCurCard({
						...cardHook.curCard, selectedBackground: index, partsToRecolor: myArr
					});
	...
	return (
		<>
			<Button onClick={onOpen} variant="white">Select Background</Button>
