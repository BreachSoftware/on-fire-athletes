...
function ARViewer() {
	...
	async function onQRResult(result: Result) {
		...
		const stringedResult = typeof result === "string" ? result : result.getText();
	...
	function reloadWithNewCard() {
		window.location.href = window.location.href.split("?")[0].concat(`?card=${qrResult}`);
	}
		...
		<>
			...
			{ qrResult !== "" && qrResult !== getQueryParam("card") &&
				<Center>
					<Button
						zIndex={3}
						verticalAlign="center" alignSelf="center"
						backgroundColor="green.100"
						borderWidth="1px" borderColor="green.1000" borderRadius="5px"
						position="absolute" top="80vh" height="10vh" width="90vw" maxW="500px"
						onClick={reloadWithNewCard}
					>
						<Text fontSize="xl" textColor="gray.1400">Scan Different Card</Text>
					</Button>
				</Center>
			}
			...
			<a-scene
				...
				filterMinCF=".01" filterBeta=".001" missTolerance="40" // warmupTolerance="100" missTolerance="1000"
			...
			>
				...
				<a-assets>
					...
					<img
						...
						alt="The OnFire card"
					/>
					<img id="play-image" src={PlayImage.src} alt="Play button" />
				</a-assets>
				...
				<a-entity mindar-image-target="targetIndex: 1">
					...
					<a-entity
						...
						rotation="0 0 -90" position="0 0 0.001" scale="0.058 0.058 0.058" cloak
					></a-entity>
				</a-entity>
