			...
			>
				...
				<HStack width={"100%"} justifyContent={"space-between"} flexWrap={"wrap"}>
					...
					<Grid
						...
						templateRows={{ base: "1fr 1fr 1fr 1fr 1fr", md: "1fr 1fr, 1fr 1fr, 1fr 1fr" }}
						gap={4}
						width={"100%"}
					>
						...
						<DropdownInput
							isDisabled={card.curCard.inputDisabled}
							title={card.curCard.sport === "" ? "Sport*" : card.curCard.sport}
							options={[
						...
						<DropdownInput
							isDisabled={card.curCard.inputDisabled}
							title={ card.curCard.careerLevel === "" ? "Career Level" : card.curCard.careerLevel}
