    ...
    return (
        <>
            ...
            >
                ...
                >
                    <Radio
                        boxShadow={determineBoxShadow("1")}
                        value="1"
                        gap={props.option3text ? 1 : 0}
                        _checked={{
                            dropShadow: "none",
                    ...
                    >
                        {props.option1text === "All" ? (
                            ...
                            <Icon
                                ...
                                top={"6px"}
                                as={CheckIcon}
                                color={determineCheckColor(1)}
                            />
                        )}
                        <Text
                            textColor={
                                props.value === "1" ? "green.100" : "white"
                            }
                            fontSize={"14px"}
                            fontWeight="medium"
                        >
                    ...
                    <Radio
                        boxShadow={determineBoxShadow("2")}
                        value="2"
                        gap={props.option3text ? 1 : 0}
                        _checked={{
                            dropShadow: "none",
                    ...
                    >
                        {props.option1text === "All" ? (
                            ...
                            <Icon
                                ...
                                top={"6px"}
                                as={CheckIcon}
                                color={determineCheckColor(2)}
                            />
                        )}
                        <Text
                            textColor={
                                props.value === "2" ? "green.100" : "white"
                            }
                            fontSize={"14px"}
                            fontWeight="medium"
                        >
                    ...
                    {props.option3text && (
                        <Radio
                            boxShadow={determineBoxShadow("3")}
                            value="3"
                            gap={props.option3text ? 1 : 0}
                            _checked={{
                                dropShadow: "none",
                        ...
                        >
                            {props.option1text === "All" ? (
                                ...
                                <Icon
                                    ...
                                    top={"6px"}
                                    as={CheckIcon}
                                    color={determineCheckColor(3)}
                                />
                            )}
                            <Text
                                textColor={
                                    props.value === "3" ? "green.100" : "white"
                                }
                                fontSize={"14px"}
                                fontWeight="medium"
                            >
