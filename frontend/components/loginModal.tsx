...
import { Modal, ModalBody, ModalCloseButton, ModalContent, ModalOverlay, VStack, useToast } from "@chakra-ui/react";
...
export default function LoginModal(props: LoginModalProps) {
	 ...
	 */
	function authenticationDecision(res: { success: boolean; message: string }) {
		if (res.success) {
			props.onClose();
			toast({
				title: "Signed in",
	...
	return (
		<Modal isOpen={props.isOpen} onClose={props.onClose} size="4xl" isCentered>
			...
			<ModalContent borderRadius={"1rem"} w={{ base: "90%", sm: "90%", md: "37%" }} bgColor="#171C1B">
				<ModalCloseButton />
				<ModalBody>
